         ...
         <header className="absolute top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-slate-100">
            <div className="mx-auto flex h-20 md:h-24 max-w-7xl items-center justify-between px-6 md:px-12">
               <div className="flex items-center cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                  {/* Logo oficial reduzida para ~50% conforme diretrizes premium */}
                  <img src="/logo.png" alt="Expertise Licitatória" className="h-16 md:h-20 w-auto object-contain drop-shadow-sm" />
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                  ...
                  <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }} className="bg-[#0A2540] border border-[#0A2540] rounded-3xl p-8 shadow-2xl transform md:-translate-y-4 flex flex-col relative">
                     ...
                     <ul className="space-y-4 mb-8 flex-1">
                        ...
                        <li className="flex items-start gap-3"><CheckCircle weight="fill" className="text-[#EA580C] w-5 h-5 shrink-0" /><span className="text-sm font-medium text-white">100 Análises do Especialista Digital (Lex)/mês</span></li>
                        <li className="flex items-start gap-3"><CheckCircle weight="fill" className="text-[#EA580C] w-5 h-5 shrink-0" /><span className="text-sm font-medium text-white">Envio Automático de Propostas</span></li>
                     </ul>
                  ...
                  <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }} className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:shadow-lg transition-all flex flex-col">
                     ...
                     <ul className="space-y-4 mb-8 flex-1">
                        ...
                        <li className="flex items-start gap-3"><CheckCircle weight="fill" className="text-emerald-500 w-5 h-5 shrink-0" /><span className="text-sm font-medium text-slate-700">Especialista Digital Lex Ilimitado</span></li>
